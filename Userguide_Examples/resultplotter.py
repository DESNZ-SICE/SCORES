...
dataname = "hydrogenmediumgashigh"
capacityfile = f"log/manifestolimits/{dataname}Capacities.csv"
costsfile = f"log/manifestolimits/{dataname}Costs.csv"
...
gen_names = [
    ...
    "Gen Solar",
    "Gen Nuclear",
    "Disp Dispatchable_Gas",
]

shortgen_names = ["Onshore", "Offshore", "Solar", "Nuclear", "Gas"]
...
totaldemand = capacities["Total Demand (GWh)"].iloc[0] / (1000 * 5)
totalcurtailment = capacities["Total Curtailment (GWh)"].iloc[0] / (1000 * 5)
